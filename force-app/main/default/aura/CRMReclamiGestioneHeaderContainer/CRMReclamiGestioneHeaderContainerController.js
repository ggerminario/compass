({
    ...
    isDataScadenzaEdit : function(cmp,event,helper){
        
       
        var action3=cmp.get('c.isDataScadenzaWritable');
    
        action3.setParam('tipo_mdt',cmp.get('v.tipoDettagliContainerTipo'));
    ...
    clacolaScadenza: function(component, event, helper){
        helper.clacolaScadenza(component,event,helper);
    }
