    ...
    onButtonPressed:function(cmp,event,helper){
        ...
        //----------------
            if(cmp.get('v.nome') && cmp.get('v.cognome')){
                console.log('Codice Fiscale --> '+ cmp.get('v.codFiscale'));
                console.log('Provincia nascita --> '+ cmp.get('v.provNascita'));
...
//                            'v.cognome','v.nome','v.dataNascita','v.codFiscale'];
                            'v.cognome','v.nome','v.dataNascita','v.codFiscale', 'v.provNascita'];// VARIAZIONE INSERIMENTO PROVNASCITA
                var dataMap={};
