({
    ...
    scriptPopulate : function(cmp, event, helper) {
        ...
        row.map((rigaSel) => {console.log ('rigaSEl: ' + JSON.stringify(rigaSel)); return idScript=rigaSel.Id, startDate=rigaSel.StartDate__c,endDate=rigaSel.EndDate__c, descrizione=rigaSel.descrizione})
        console.log('v.idScript: ' + idScript);
