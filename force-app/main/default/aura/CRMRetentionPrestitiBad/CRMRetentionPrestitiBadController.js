    ...
    init : function(cmp, event, helper) { 
        cmp.set("v.tableColumns", [
           {label: 'Esito Retention Memorizzato', fieldName:'dispositionName', type: 'text',fixedWidth:200},
            ...
            {label: 'Flag Partner', fieldName: '', type: 'text',fixedWidth:120},
                                   ...
                                   if(check)
                                   {
                                       if(redirect)
                                       {
                                           ...
                                           evt.setParams({
                                               ...
                                               componentAttributes : {
                                                   parametriEsterni : { 
                                                       "codClienteOCS" : wrapObj.codCliente ? wrapObj.codCliente : '',
                                                       "codCategoria"  : wrapObj.postVenditaId ? wrapObj.postVenditaId : '',
