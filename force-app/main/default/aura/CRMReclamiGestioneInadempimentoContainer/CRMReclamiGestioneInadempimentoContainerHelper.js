    ...
    getCurrentValues : function(cmp){
        ...
        action.setCallback(this,function(resp){
            ...
            if(state=='SUCCESS'){               
                ...
                var FTSent = (cmp.get('v.FTSent') ? cmp.get('v.FTSent') : '0');
                var FTReceived = (cmp.get('v.FTReceived') ? cmp.get('v.FTReceived') : '0');
                console.log('@@@@@@@@@@@@@@@@@@@@ ' + FTSent + ' @@@@@ ' + FTReceived + 'Stage :' + stageInadempimento);
                var checkReadonly = (FTSent != FTReceived && FTSent == '2') || ((FTSent != FTReceived && FTSent == '4')) || (stageInadempimento == '4171');// || (FTSent == '4') || (stageInadempimento == '4171') ? true : false ;
                cmp.set('v.isReadonlyGravita',checkReadonly);
