({
	...
	valutaAutonomiaAttivita: function(component, event) {
        var isAttivitaOdontoiatriche = component.get("v.isAttivitaOdontoiatriche");
        console.log("*** isAttivitaOdontoiatriche :: " + isAttivitaOdontoiatriche);
        var spinner = component.find('spinnerComponent');
        spinner.incrementCounter();        
        ...
        action.setParams({
            ...
            Macro_Area :  component.get("v.SelMacroArea"),
            Prodotto_Dominante:  component.get("v.SelProdDom"),
            isAttivitaOdontoiatriche: isAttivitaOdontoiatriche
        });        
        action.setCallback(this, function(response){
            if (response.getState() == 'SUCCESS'){                
