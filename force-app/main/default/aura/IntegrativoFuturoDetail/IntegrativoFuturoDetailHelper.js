...
//              IntervistaIntegrativo.Ragione_Sociale_Intermediario__c +
      ...
      if (!comodityCheklist.length || !listOfStringCSERVNotExist.length) {
        ...
        action.setCallback(this, function(response) {
          ...
          if (state === "SUCCESS") {
            ...
            console.log('assicurazionecount --> '+ assicurazioneCount);
    ...
    getUserCtrl: function(component, event){
        console.log('-------------------------------------------------------');
        console.log('--  getUserCtrl');         
       
        var action2 = component.get("c.getUserOperatore");
        console.log('mi fermo qui');
        action2.setCallback(this, function(resp) {
            console.log('resp.getState()'+resp.getState())
            if(resp.getState()=='SUCCESS'){
                component.set("v.nomeOperatore", resp.getReturnValue());
            }
        });
