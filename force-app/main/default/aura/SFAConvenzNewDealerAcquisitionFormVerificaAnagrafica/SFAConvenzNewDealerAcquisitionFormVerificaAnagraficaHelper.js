	...
	callGetDealerAcquisition: function (component, event) {
		...
		action.setCallback(this, function(response){
			if (response.getState() == 'SUCCESS'){
                ...
                var recordtypeid = dati.recordtypeid;
			...
			if (response.getState() == 'SUCCESS'){
                ...
                if(datiChiamataOCS.chiamataOK){
                    ...
                    if(datiChiamataOCS.indirizziElenco.length==1){
                        ...
                        var mailPosCode = component.find("MailingPostalCode");
                        var mailStreet = component.find("MailingStreet");
                        if(mailPosCode != null){
                            mailPosCode.set("v.value",datiChiamataOCS.indirizziElenco[0].cap);
                        }
                        if(mailStreet != null){
                            mailStreet.set("v.value",datiChiamataOCS.indirizziElenco[0].indirizzo);
                        }
