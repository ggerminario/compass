({
    ...
    handleChangeHelperAgg:function(cmp,helper){
        console.log('XXX handleChangeHelperAgg');
 ...
 //           console.log('XXX temp:'+temp+':cmp.get(temp):'+cmp.get('v.'+temp)+':');
            if(!cmp.get('v.'+temp)){
                console.log('XXX ERRORE temp:'+temp+':');
                res=false;
                msg+=attrMap[temp]+', ';
            }
        });
