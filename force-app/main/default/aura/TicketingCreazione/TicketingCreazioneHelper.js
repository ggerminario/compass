({
    ...
    createCase : function(component, event) {
        ...
        if(component.get("v.Cat_CHN_ACQ") == true){
            ...
            tic.Canale_OCS_Acquisizione__c = canaleAcquisizione1;
        }
        if(component.get("v.Cat_CHN_MAP") == true){
            component.set("v.Ticket.Description",tic.Description
                                              + ' \n ' + 'Canale Acquisizione: ' +canaleAcquisizione2);
            tic.Canale_OCS_Acquisizione__c = canaleAcquisizione2;
        }
        ...
        var selezioneFiliale = component.find("selezioneFiliale");
        if (selezioneFiliale.getFilialeSelezionata()!=null) {
            tic.Branch__c = selezioneFiliale.getFilialeSelezionata().Id;
        }
        console.log("tic.Branch__c : " + tic.Branch__c);
        tic.Tipo_Prodotto__c = prod;
        tic.livello_firma__c = livFirma;
        action.setParams({
            Ticket : tic,
            MapFiles: MapFiles2,
            catIdS: catIdComp
        ...
        action.setCallback(this, function(data) {
            ...
            var lengMetadata = retVal.length;
                    ...
                    if(TypeForm =="ATTACH"){
                        ...
                        component.set("v.Script_ATTACH", entry.Script__c);
                    ...
                    if(TypeForm == "COD_PRT"){
                        ...
                        component.set("v.Script_COD_PRT", entry.Script__c);
                    ...
                    if(TypeForm == "COD_PRT_WS"){
                        ...
                        component.set("v.Script_COD_PRT_WS", entry.Script__c);
                        component.set("v.TipoDocMT",entry.DocType__c);
                    ...
                    if(TypeForm == "COD_PRT_DELIB"){
                        ...
                        component.set("v.Script_COD_PRT_DELIB", entry.Script__c);
                        component.set("v.TipoDocMT",entry.DocType__c);
