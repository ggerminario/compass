({
    ...
    continuCA1: function (component, event, helper) {
        if (!helper.checkAutonomiPlus(component, event)) {
            helper.showToast('Per il prodotto Autonomi Plus bisogna selezionare il Dettaglio Prodotto','error');
            return;
        }
    ...
    searchFiliale : function(component,event,helper) {
        ...
        var productId = component.get("v.idProdottoSelezionato");
        ...
        action.setCallback(this, function (response) {
            ...
            if (response.getState() === "SUCCESS") {
                console.log('chiamata in success ');
                resultat = response.getReturnValue();
                if(resultat.listFiliale){
                    helper.filtraFilialiAutonomiPlus(component,resultat.listFiliale,productId,resultat.result);
/*                  component.set("v.showListFiliale",true);
                    ...
                    //console.log('### resultat listaFiltrata ', resultat.listaFiltrata);
