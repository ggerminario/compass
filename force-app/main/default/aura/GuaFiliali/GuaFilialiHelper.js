({
        ...
        action.setCallback(this, function(response) {
            if (response.getState() === "SUCCESS") {
                ...
                if (!result.erreur) {
                    ...
                    this.getUnitaAffari(component, event, helper);
                } else {
    ...
    getUnitaAffari: function(component, event, helper) {
        var caseDealer = component.get('v.filialeCase');
