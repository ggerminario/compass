({
    doInit : function (component,event,helper){
        var action = component.get("c.isSFAUser");
        action.setCallback(this,function(response){
            var state=response.getState();
            console.log("doInit "+response.getReturnValue());
            if(state ==="SUCCESS")  component.set("v.SFAUser",response.getReturnValue());            
            else helper.showToast("Errore identificazione SFA User","Error");
        });
    ...
    handleDetailEvent : function(component,event,helper) {
        ...
        // devo riaggiornare anche la sezione in basso del dettaglio 
