 ...
 * @Last Modified On   : 15/1/2020, 09:36:39
 * @Modification Log   : 
 *==============================================================================
...
({
    ...
    conferma: function (cmp, event, helper) {
        ...
        action.setCallback(this, function (response, helper) {
            ...
            //console.log("### RISPOSTA STATO: "+response.getState());
            //console.log("### RISPOSTA : "+JSON.stringify(response.getReturnValue()));
