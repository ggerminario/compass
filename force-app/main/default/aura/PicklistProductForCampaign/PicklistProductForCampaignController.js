({
	init : function(cmp, event, helper) {
        ...
        action.setParams({'idcamp':cmp.get('v.recordId')});
        ...
        action.setCallback(this, function(response) { 
            ...
            if (state == 'SUCCESS') {
                ...
                console.log('PRODOTTI TROVATI: ' + JSON.stringify(results));
    ...
    saveProdotto : function(cmp,event, helper) {
        ...
        console.log('Prodotto selezionato: ',cmp.get('v.ProdottoSelezionato'));
