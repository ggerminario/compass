        ...
        action.setCallback(this, function(response) {
            ...
            if (state === 'SUCCESS'){
				...
				console.log(JSON.stringify(errors));
                 helper.showToast('Aggiornamento fallito. '+message,'error');
            }          
        });
        $A.enqueueAction(action);
 ...
 * */
	...
	console.log(workbookXML);
		...
		setMaxMinDate: function (component) {
			var today = new Date('2020-02-17T03:24:00');
			var monthDigit = today.getMonth() + 1;
			var minMonth;
			if(monthDigit - 4 <= 0){
				minMonth = monthDigit + 12 - 4;
			} else {
				minMonth = monthDigit - 4;
			}
			...
			var dateMin = minYear + "-" + minMonth + "-"+minDay ;
			var dateMax = today.getFullYear() + "-" + monthDigit + "-"+this.getLastDate(today.getFullYear(),monthDigit);
			console.log('dateMin->'+dateMin);
			console.log('dateMax->'+dateMax);
			component.set('v.minDate',  dateMin);
			component.set('v.maxDate', dateMax);
		}
