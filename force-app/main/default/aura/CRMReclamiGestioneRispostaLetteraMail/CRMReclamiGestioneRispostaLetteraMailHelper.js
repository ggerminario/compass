({
    ...
    checkAllegati:function(cmp,allegati){
        ...
        return res;*/
        if(allegati!=undefined && allegati.length>0){
            return true;
        }else return false;
    ...
    inviaRispostaHelper : function(cmp,allegati){
        ...
        var mittente = cmp.get('v.aa');
        var copia = cmp.get('v.cc');
        var copiaNascosta=cmp.get('v.bcc');
        var testo = cmp.get('v.mailText');
        var c = cmp.get('v.campiCase');
        var cliente = cmp.get('v.clienteSelezionato');
        var pratica = JSON.stringify(cmp.get('v.praticaSelezionata'));
    ...
    reset: function(component, event){
        ...
        var inserimentoAllegati = component.find('inserimentoAllegati');
        if(inserimentoAllegati!=undefined){
			var xcsAllegati = inserimentoAllegati.resetMethod(); 
        	console.log("Reset Padre Lettera");
        } 
