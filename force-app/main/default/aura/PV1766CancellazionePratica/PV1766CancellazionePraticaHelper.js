    ...
    onPraticaSelected: function (cmp) {
		...
		if (this.checkPraticaSelezionata(cmp) == "") {
            ...
            if (messaggi == "") {
                ...
                if (messaggi == "") {
                    //aggiungo controllo se pratica già inserita e in lavorazione
                    //verifico se la pratica è già inserita ed in corso di lavorazione
                    console.log('pratica.numPratica : ' + pratica.numPratica);
                    var action=cmp.get('c.checkPratica');
                    action.setParams({
                        "pratica" : pratica.numPratica
                    });   
                    action.setCallback(this,function(response){
                        console.log('response.getState() : ' + response.getState());
                        console.log('response : ' + JSON.stringify(response));
                        if(response.getState()=='SUCCESS'){
                            messaggi = response.getReturnValue();    
