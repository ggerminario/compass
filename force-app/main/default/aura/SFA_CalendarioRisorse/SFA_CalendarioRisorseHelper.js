	...
	initApex : function(component, event, helper) {
        ...
        action.setCallback(this,function(resp){
            ...
            if(resp.getState()=='SUCCESS'){
                ...
                if(branch)    component.set('v.users', initWrapper.filialistiPerFiliale[branch.OCS_External_Id__c]);
                component.set('v.branches', initWrapper.branches);
                component.set('v.branch', branch);
                if(branch) component.set('v.branchOCSExternalId', branch.OCS_External_Id__c);
