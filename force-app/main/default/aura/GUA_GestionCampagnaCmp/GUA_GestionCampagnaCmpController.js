({
    ...
    navigToElencoDiCampagneTab: function (component, event, helper) {
        helper.clearAll(component, event);
        component.set('v.checkload', false);
        //make Nomecampagna tab active and show tab data
        component.find("elencoDiCampagneId").getElement().className = 'slds-tabs--scoped__item slds-active customClassForTab';
        component.find("elencoDiCampagneTabDataId").getElement().className = 'slds-tabs--scoped__content slds-show customClassForTabData';
