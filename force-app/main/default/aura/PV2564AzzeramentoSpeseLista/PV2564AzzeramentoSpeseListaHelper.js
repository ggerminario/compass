 ...
 * @Last Modified On   : 23/1/2020, 09:58:20
 * @Modification Log   : 
 *==============================================================================
...
//        this.loadSpese(cmp, event, helper);
    ...
    totaliSpese: function (cmp) {
        ...
        for(i;i<elencoSpese.length;i++){
            totMaturato+=elencoSpese[i].importoMaturato;
            totIncassato+=elencoSpese[i].importoIncassato;
            totSaldo+=elencoSpese[i].saldo;
        }
        console.log("Tot Maturato : " + totMaturato);
        totali.push(parseFloat(totMaturato).toFixed(2) );
        console.log("Tot Incassato : " + totIncassato);
        totali.push(parseFloat(totIncassato).toFixed(2) );
        console.log("Tot Saldo : " + totSaldo);
        totali.push(parseFloat(totSaldo).toFixed(2) );
        
        cmp.set("v.totaliSpese",totali);
