({
    ...
    handleSuccess: function(cmp,event,helper){
        let action = cmp.get('c.cloneScript');
            ...
            console.log('///OLDSCRIPT: ' + oldScript.Text__c);
        	let esecuzione;
        	let controllDate;
       ...
       cmp.set('v.openModaleScriptEdit',false);
        ...
        cmp.set('v.idScript', undefined);
        cmp.set('v.startdate', undefined);
        cmp.set('v.endDate', undefined);
    },
    ...
    handleLoad: function(cmp,event,helper){
        ...
        if (oldScript != null && oldScript != undefined) {
            console.log('ScriptRecord ',oldScript.Text__c);
            cmp.set('v.text', oldScript.Text__c);
        }
