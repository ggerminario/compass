({
    ...
    setTestoStd : function(cmp, event){
        cmp.set("v.testoStandardSelezionato", event.getSource().get("v.value"));
    },
    ...
    inviaRisposta : function(cmp, event, helper){ 
        ...
        var testoStandard = cmp.get('v.testoStandardSelezionato');
        ...
        if(selezioneFrode!=null && selezioneTestoStd!=null && firma!=null){
            
            if(selezioneTestoStd=='Si' && testoStandard==undefined){
