({
    ...
    ripristina: function(component, event, helper) {
        var listC = component.get('v.listToProcess');
        if(listC.length>1){
            console.log('passato qui if');
            console.log('listC');
            console.log(listC);
	        helper.multiRipristina(component, event);
        }else{
            console.log('passato qui else');
            console.log('listC');
            console.log(listC);
	        helper.ripristina(component, event);
        }
//        helper.ripristina(component, event);
    },
