	...
	callGetDossier: function (component, event) {
		...
		action.setCallback(this, function(response){
			...
			if (response.getState() == 'SUCCESS'){
                ...
                console.log('***CompErrorCode ::'+ component.get("v.errorCode"));
				if (initData.isInManoAFiliale == false) {
                    ...
                    if (initData.errorCode < 0) {
                        console.log('***CompErrorCode2 ::'+ initData.errorCode);
		...
		action.setCallback(this, function(response){
			...
			if (response.getState() == 'SUCCESS'){
				...
				if (datiListaDocumenti) {
                    ...
                    component.set("v.lstDossierDocumentoAddizionaliMutuamenteEsclusivi", datiListaDocumenti.lstAddizionaliMutuamenteEsclusivi);
