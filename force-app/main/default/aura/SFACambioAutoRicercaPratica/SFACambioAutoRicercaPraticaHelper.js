({
   ...
   UserProfile : function(component, event, helper) {

	var action = component.get("c.isNotBranchProfile");	
        action.setCallback(this, function(response){
           
            if (response.getState() == 'SUCCESS'){
				var valore = response.getReturnValue();
                
                 component.set("v.PFilale", valore);
               }
        });
