({
    utenzaPasscom: function(component, event, helper) {
        ...
        console.log('#################  utenzaPasscom ' + JSON.stringify(component.get("v.caseDealer")));
       var caseD = component.get("v.caseDealer");
        
        var codiceIntermediario =  caseD.Account.getCodice_Cliente__c;    
        var resultat;
        var codiceUtenza = "";
        action.setParams({
